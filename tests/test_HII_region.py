...
rt06_2_src = {'source_type': 0, 'spectrum_type': 0, 
    ...
    'spectrum_multifreq': 1, 'SecondaryIonization': 0}
...
rt06_2_src = {'source_type': 0, 'spectrum_type': 0, 
    ...
    'spectrum_E': [17.98, 31.15, 49.09, 76.98],
    'spectrum_LE': [0.23, 0.36, 0.24, 0.06],
    'spectrum_multifreq': 1, 'SecondaryIonization': 1}
rs = rt1d.sources.RadiationSourceIdealized(**rt06_2_src)
rt = rt1d.Radiation(grid, rs, **rt06_2_src)
...
# Plot up radial profiles at t = 500 Myr        
pl.semilogy(grid.r_mid / grid.pf['LengthUnits'], data['h_1'], color = 'b', ls = '-')
pl.semilogy(grid.r_mid / grid.pf['LengthUnits'], data['h_2'], color = 'b', ls = '--')
pl.ylim(1e-5, 1.5)
raw_input('')
