...
pl.semilogy(ds.data[0].r / cm_per_kpc, ds.data[2].x_HI, ls = '-', color = 'k', label = r'$1 - x_i$')
pl.semilogy(ds.data[0].r / cm_per_kpc, ds.data[6].x_HI, ls = '-', color = 'k')
pl.semilogy(ds.data[0].r / cm_per_kpc, ds.data[20].x_HI, ls = '-', color = 'k')
pl.semilogy(ds.data[0].r / cm_per_kpc, ds.data[2].x_HII, ls = '--', color = 'k', label = r'$x_i$')
pl.semilogy(ds.data[0].r / cm_per_kpc, ds.data[6].x_HII, ls = '--', color = 'k')
pl.semilogy(ds.data[0].r / cm_per_kpc, ds.data[20].x_HII, ls = '--', color = 'k')
pl.xlabel(r'$r$ (kpc)')
pl.ylabel(r'$x_i$, $1-x_i$')
pl.xlim(0, 7)
pl.ylim(1e-5, 1.5)
pl.legend(loc = 'lower right', frameon = False)
pl.annotate('10', (1.8, 0.5))
pl.annotate('30', (2.9, 0.5))
pl.annotate('100', (4.3, 0.5))
