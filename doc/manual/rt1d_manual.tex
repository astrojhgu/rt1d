...
primary reference for this code is \cite[\href{http://arxiv.org/abs/1204.1944}{arxiv:1204.1944}]{Mirocha2012} -- much of the text has
...
%% SED studies
%%%
\section{Verifying Discrete SEDs with \texttt{rt1d}}
In \citet{Mirocha2012}, we used \texttt{rt1d} to verify new, optimally selected discrete spectral energy distributions for sources of ultraviolet and X-ray photons.  As we optimize more and more SEDs for fully 3D cosmological  radiation-hydro simulations, \texttt{rt1d} remains a quick and easy tool for verifying that the SEDs we're using are acceptable.
