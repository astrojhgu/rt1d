"""
AnalyzeTest2_Resolution.py

Author: Jordan Mirocha
Affiliation: University of Colorado at Boulder
Created on 2011-07-03.

Description: Analyze results of RT06 test problem #2 run with differing spatial resolutions.
...
r, x1, x2, x3, T1, T2, T3 = misc.readtab('c100/RT_Test2_RadialProfiles.dat')
pl.semilogy(r, x1, ls = '-', color = 'k', label = r'$n_{\mathrm{c}} = 100$')
pl.semilogy(r, x2, ls = '-', color = 'k')
pl.semilogy(r, x3, ls = '-', color = 'k')
r, x1, x2, x3, T1, T2, T3 = misc.readtab('c200/RT_Test2_RadialProfiles.dat')
pl.semilogy(r, x1, ls = '--', color = 'blue', label = r'$n_{\mathrm{c}} = 200$')
pl.semilogy(r, x2, ls = '--', color = 'blue')
pl.semilogy(r, x3, ls = '--', color = 'blue')
r, x1, x2, x3, T1, T2, T3 = misc.readtab('c400/RT_Test2_RadialProfiles.dat')
pl.semilogy(r, x1, ls = ':', color = 'red', label = r'$n_{\mathrm{c}} = 400$')
pl.semilogy(r, x2, ls = ':', color = 'red')
pl.semilogy(r, x3, ls = ':', color = 'red')
r, x1, x2, x3, T1, T2, T3 = misc.readtab('c800/RT_Test2_RadialProfiles.dat')
pl.semilogy(r, x1, ls = '-.', color = 'green', label = r'$n_{\mathrm{c}} = 800$')
pl.semilogy(r, x2, ls = '-.', color = 'green')
pl.semilogy(r, x3, ls = '-.', color = 'green')
r, x1, x2, x3, T1, T2, T3 = misc.readtab('c1600/RT_Test2_RadialProfiles.dat')
pl.semilogy(r, x1, ls = '-', color = 'magenta', label = r'$n_{\mathrm{c}} = 1600$')
pl.semilogy(r, x2, ls = '-', color = 'magenta')
pl.semilogy(r, x3, ls = '-', color = 'magenta')
#r, x1, x2, x3, T1, T2, T3 = misc.readtab('c3200/RT_Test2_RadialProfiles.dat')
#pl.semilogy(r, x1, ls = '--', color = 'cyan', label = r'$n_{\mathrm{c}} = 3200$')
#pl.semilogy(r, x2, ls = '--', color = 'cyan')
